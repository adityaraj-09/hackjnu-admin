        ...
        <div className="top">
            ...
            <div className="r">
                <div className="showel">
                    <div className="headingss">Shovel</div>
                    <div className="row">
                        <div>Active:</div>
                        <div>{data && data["shovels"] && data["shovels"][0]}</div>
                    </div>
                    <div className="row">
                        <div>Inactive:</div>
                        <div>{data && data["shovels"] && data["shovels"][1] - data["shovels"][0]}</div>
                    </div>
                </div>
                <div className="Dumper">
                    ...
                    <div className="row">
                        <div>Active:</div>
                        <div>{data && data["dumpers"] && data["dumpers"][0]}</div>
                    </div>
                    <div className="row">
                        <div>Inactive:</div>
                        <div>{data && data["dumpers"] && data["dumpers"][1] - data["dumpers"][0]}</div>
                    </div>
                </div>
            </div>
        </div>
